...
public class AmountFormatter_BF
{
	...
	public static String formatAmount(KMyMoneyFile kmmFile, 
									  BigFraction amt, KMMQualifSecCurrID secCurrID) {
		if ( amt == null ) {
	...
	public static String formatAmount(KMyMoneyFile kmmFile,
									  BigFraction amt, KMMQualifSecCurrID secCurrID, Locale lcl) {
		if ( amt == null ) {
		...
		NumberFormat nf = getSecFormat(secCurrID, lcl);
	...
	public static NumberFormat getCurrencyFormat(KMMQualifSecCurrID secCurrID) {
		return getSecFormat(secCurrID, Locale.getDefault());
	}
	
	public static NumberFormat getSecFormat(KMMQualifSecCurrID secCurrID, Locale lcl) {
